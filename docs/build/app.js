		...
		if (model.$ === 'Nothing') {
			...
			if (_n2.$ === 'Nothing') {
				return A2(
					...
					A2(elm$core$Basics$composeL, wrap, annaghi$dnd_list$DnDList$GotDragged),
...
var annaghi$dnd_list$DnDList$Position = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$int = _Json_decodeInt;
var annaghi$dnd_list$DnDList$pageX = A2(elm$json$Json$Decode$field, 'pageX', elm$json$Json$Decode$int);
var annaghi$dnd_list$DnDList$pageY = A2(elm$json$Json$Decode$field, 'pageY', elm$json$Json$Decode$int);
				...
				A2(
					...
					A2(
						...
						A2(
							elm$core$Basics$composeL,
							wrap,
							A2(annaghi$dnd_list$DnDList$DragStart, dragIndex, elementId)),
						A3(elm$json$Json$Decode$map2, annaghi$dnd_list$DnDList$Position, annaghi$dnd_list$DnDList$pageX, annaghi$dnd_list$DnDList$pageY))))
			]);
	});
...
var annaghi$dnd_list$DnDList$translate = F2(
	function (x, y) {
		return 'translate3d(' + (annaghi$dnd_list$DnDList$px(x) + (', ' + (annaghi$dnd_list$DnDList$px(y) + ', 0)')));
	});
var elm$core$Basics$round = _Basics_round;
var elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var elm$html$Html$Attributes$style = elm$virtual_dom$VirtualDom$style;
var annaghi$dnd_list$DnDList$draggedStyles = F2(
...
var annaghi$dnd_list$DnDList$dropEvents = F2(
			...
			[
				...
				A2(
					...
					elm$json$Json$Decode$succeed(
						wrap(
							annaghi$dnd_list$DnDList$DragOver(dropIndex)))))
			]);
	});
			...
			return elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						...
						A2(
							elm$json$Json$Decode$map,
							A2(elm$core$Basics$composeL, wrap, annaghi$dnd_list$DnDList$Drag),
							A3(elm$json$Json$Decode$map2, annaghi$dnd_list$DnDList$Position, annaghi$dnd_list$DnDList$pageX, annaghi$dnd_list$DnDList$pageY))),
...
var annaghi$dnd_list$DnDList$rotate = F3(
	function (i, j, list) {
...
var annaghi$dnd_list$DnDList$reorder = F3(
	function (model, dropIndex, list) {
		if (model.$ === 'Just') {
			var m = model.a;
			if (_Utils_cmp(m.dragIndex, dropIndex) < 0) {
				return A3(annaghi$dnd_list$DnDList$rotate, m.dragIndex, dropIndex, list);
			} else {
				if (_Utils_cmp(m.dragIndex, dropIndex) > 0) {
...
var annaghi$dnd_list$DnDList$update = F3(
				...
				return _Utils_Tuple2(
					annaghi$dnd_list$DnDList$Draggable(
						A2(
							...
							model)),
					A3(annaghi$dnd_list$DnDList$reorder, model, dropIndex, list));
			case 'DragEnd':
				return _Utils_Tuple2(
					annaghi$dnd_list$DnDList$Draggable(elm$core$Maybe$Nothing),
					list);
			default:
				if (msg.a.$ === 'Err') {
					return _Utils_Tuple2(
...
var annaghi$dnd_list$DnDList$create = function (_n0) {
	...
	return {
		...
		draggable: annaghi$dnd_list$DnDList$Draggable(elm$core$Maybe$Nothing),
		draggedIndex: annaghi$dnd_list$DnDList$draggedIndex,
		draggedStyles: annaghi$dnd_list$DnDList$draggedStyles(movement),
		dropEvents: annaghi$dnd_list$DnDList$dropEvents(message),
		subscriptions: annaghi$dnd_list$DnDList$subscriptions(message),
